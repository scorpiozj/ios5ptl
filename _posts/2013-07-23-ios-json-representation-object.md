...
Thanks to the evolution of xcode, we do not need synthesize the property manually as xcode does automatically for us. However, apparently the code is not so "clean".
Later
